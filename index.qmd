...
<div class="exp-body"><p>Mapped current- and future-state workflows. Designed a Power Platform automation (Power Apps, Power Automate, SharePoint) that <strong>cut manual coordination effort by 90%</strong>; now contributing in a Power BI data migration across merging banking systems.</p></div>
</div>

<div class="exp-row">
<div class="exp-meta"><span class="role">Continuous Improvement Expert</span>Snapp<br>Nov 2020 – Dec 2023</div>
<div class="exp-body"><p>Applied DMAIC and fishbone root-cause analysis to redesign customer onboarding end-to-end processes, <strong>cutting cycle time 65%</strong> and <strong>manual verification workload 60%</strong>.</p></div>
</div>

<div class="exp-row">
<div class="exp-meta"><span class="role">Process Excellence Expert</span>Hyper-Me<br>Jan 2018 – Nov 2020</div>
<div class="exp-body"><p>Mapped operational workflows, using root-cause analysis to prioritize improvement opportunities; drove <strong>20% immediate adoption</strong> on simplification and automation initiatives.</p></div>
</div>

<div class="exp-row">
<div class="exp-meta"><span class="role">Business Process Analyst</span>Shatel<br>Jun 2015 – Dec 2017</div>
<div class="exp-body"><p>Designed IVR call-flow architecture and a crisis-response routing system for high-volume customer communications; built change-management frameworks <strong>achieving 80% team adoption</strong>.</p></div>
</div>
